...
const LeftImage = () => (
  <Image floated="left" size="medium" src="/images/wireframe/square-image.png" style={{ margin: '2em 2em 2em -4em' }} />
)

const RightImage = () => (
  <Image floated="right" size="medium" src="/images/wireframe/square-image.png" style={{ margin: '2em -4em 2em 2em' }} />
)
      ...
      <div>
        ...
        <Container text>
          ...
          <div ref={this.handleOverlayRef} style={overlayFixed ? fixedOverlayStyle : overlayStyle}>
            <Menu icon="labeled" style={overlayFixed ? fixedOverlayMenuStyle : overlayMenuStyle} vertical>
              <Menu.Item>
                <Icon name="twitter" />
                Twitter
              </Menu.Item>
